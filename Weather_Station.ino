...
String Email_Input = "aligalalhassan27@gmail.com";
...
String humidity_threshold = "50";
String lastHumidity;

String pressure_threshold = "1,013.25";
String lastpressure;
...
server.on("/submit", HTTP_GET, [](AsyncWebServerRequest *request){
  ...
  float temperatureThreshold = request->getParam("Temperature")->value().toFloat();
